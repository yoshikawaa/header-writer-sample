...
public final class AntPathRequestMatcherEx
		implements RequestMatcher, RequestVariablesExtractor {
	private static final Log logger = LogFactory.getLog(AntPathRequestMatcherEx.class);
	 ...
	 */
	public AntPathRequestMatcherEx(String pattern) {
		this(pattern, null);
	}
	 ...
	 */
	public AntPathRequestMatcherEx(String pattern, String httpMethod) {
	...
	public boolean equals(Object obj) {
		if (!(obj instanceof AntPathRequestMatcherEx)) {
			return false;
		}

		AntPathRequestMatcherEx other = (AntPathRequestMatcherEx) obj;
